...
\usepackage{url,hyperref,lineno,microtype,subcaption,booktabs,amssymb,amsmath}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=16cm]{dimreduc}% This is a *.eps file
	\end{center}
...
\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=16cm]{clustering}% This is a *.eps file
	\end{center}
